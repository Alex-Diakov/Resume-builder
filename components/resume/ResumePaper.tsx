...
import { allocatePages } from '../../services/export/pageAllocator';
...
export const ResumePaper: React.FC<ResumePaperProps> = ({ 
  ...
  if (!data) return <div className="p-8 text-center bg-ds-panel rounded-ds-lg text-ds-text-muted border border-ds-border">No Data Loaded</div>;
                        ...
                        {data.photo && data.showPhoto !== false && (
                          <div className="shrink-0">
                            <img 
                              src={data.photo} 
                              alt={data.name} 
                              className="w-[96px] h-[96px] object-cover rounded-ds-lg border border-resume-border shadow-ds-sm bg-white"
